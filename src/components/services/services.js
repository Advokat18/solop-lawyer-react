  ...
  return (
    <div className="solop-content-bg solop-bg">
        ...
        <div className="solop-content-services scroll-block">
            ...
            <a 
                href="./services/inheritance.html" 
                className="services-style">
                <p className="services-title">
                    Спадкове <br />
                    право
            ...
            <a 
                href="./services/enforcement.html" 
                className="services-style">
                <p className="services-title">
                    Виконавче <br />
                    право
